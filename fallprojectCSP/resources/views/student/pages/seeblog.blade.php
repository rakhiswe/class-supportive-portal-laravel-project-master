            ...
            <div class="row">
                <div class="col-md-12 post">
                    ...
                    <div class="row post-content">
                        <div class="col-md-3">
                            <a href="#">
                                <img src="http://4.bp.blogspot.com/-_lqoNpVXeU4/UkxQ7N-QW8I/AAAAAAAACTw/pni-TZyp17o/s1600/cool+share+button+effects+styles.png" width="250px" alt="" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-md-9">
                            <p>
            ...
            <div class="row">
                <div class="col-md-12 post">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>
                                <strong><a href="http://www.jquery2dotnet.com/2013/12/brand-icons-design-using-css.html" class="post-title">Brand Icons Design Using Css</a></strong></h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 post-header-line">
                    ...
                    <div class="row post-content">
                        <div class="col-md-3">
                            <a href="#">
                                <img width="250px" src="http://3.bp.blogspot.com/-u1cpORMwaDA/UkxERgVvXWI/AAAAAAAACTI/xoN30ubr-L4/s1600/Brand+Icons+using+css.png" alt="" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-md-9">
                            <p>
                            ...
                            <p>
                                <a class="btn btn-read-more" href="http://www.jquery2dotnet.com/2013/12/brand-icons-design-using-css.html">Read more</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 post">
                    <div class="row">
                        <div class="col-md-12">
                            <h4>
                                <strong><a href="http://www.jquery2dotnet.com/2013/11/cool-big-social-counter-button-with.html" class="post-title">Cool Big Social Counter Button With Bootstrap</a></strong></h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 post-header-line">
                    ...
                    <div class="row post-content">
                        <div class="col-md-3">
                            <a href="#">
                                <img width="250px" src="http://3.bp.blogspot.com/-oSHv84WZEz8/UpbDSzhtiqI/AAAAAAAACfE/LC6YzSK6GWQ/s1600/Cool+Big+Social+Counter+Button+With+Bootstrap.png" alt="" class="img-responsive">
                            </a>
                        </div>
                        <div class="col-md-9">
                            <p>
                            ...
                            <p>
                                <a class="btn btn-read-more" href="http://www.jquery2dotnet.com/2013/11/cool-big-social-counter-button-with.html">Read more</a></p>
                        </div>
                    </div>
                </div>
            </div>
